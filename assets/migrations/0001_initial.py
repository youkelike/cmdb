# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-11-15 16:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(blank=True, default=None, max_length=11, null=True, verbose_name='手机')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('switch', '服务器'), ('router', '服务器'), ('firewall', '服务器'), ('storage', '服务器'), ('NLB', '服务器'), ('wireless', '服务器'), ('software', ''), ('others', '其它类')], default='server', max_length=32, verbose_name='资产类型')),
                ...
                ('trade_date', models.DateTimeField(blank=True, null=True, verbose_name='购买时间')),
                ('expire_date', models.DateTimeField(blank=True, null=True, verbose_name='过保修期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_core_count', models.SmallIntegerField(blank=True, null=True, verbose_name='CPU核心数')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disk_iface', models.CharField(choices=[('SATA', 'SATA'), ('SAS', 'SAS'), ('SCSI', 'SCSI'), ('SSD', 'SSD')], default='SAS', max_length=32, verbose_name='接口类型')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_date', models.DateTimeField(blank=True, null=True, verbose_name='更新时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('netmask', models.CharField(blank=True, max_length=32, null=True, verbose_name='掩码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os_type', models.CharField(blank=True, max_length=32, null=True, verbose_name='操作系统类型')),
                ('os_distribution', models.CharField(blank=True, max_length=32, null=True, verbose_name='发行版本')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('os_type', models.CharField(choices=[('linux', 'Linux'), ('windows', 'Windows'), ('network_firmware', 'Network Firmware'), ('software', 'Software')], default='linux', help_text='eg. GNU/Linux', max_length=32, verbose_name='系统类型')),
                ('os_distribution', models.CharField(choices=[('windows', 'Windows'), ('centos', 'CentOS'), ('ubuntu', 'Ubuntu')], default='windows', max_length=32, verbose_name='发行版本')),
                ('version', models.CharField(help_text='eg. CentOS release 6.5 (Final)', max_length=64, unique=True, verbose_name='软件/系统版本')),
                ('language', models.CharField(choices=[('cn', '中文'), ('en', '英文')], default='en', max_length=32, verbose_name='软件/系统语言')),
            ],
            options={
